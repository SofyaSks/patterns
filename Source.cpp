...
// фабричный метод (создание объектов различных типов, при этом система долэна оставаться расширяемой (путём добавления новых объектов и типов) + стабильной)
// создание объектов, которые мы заранее знаем
